...
int main()
{
	...
	//Storing into AUX by interchanging the lines;
	printf("Interschimbare randuri:\n\n");
	
	for(i=0; i<n; i++)
	{	
		for(j=0;j<n;j++)		
		{
			//the heart of interchanging;
			AUX[n-1-i][j]=A[i][j]; // Always be careful at the = sign;
			//Here it is the main algorithm;
		}		
